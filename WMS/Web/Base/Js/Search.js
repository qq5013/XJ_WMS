...
var search_winForm = Ext.create('Ext.form.Panel', {
    frame: true,   //frame属性  
    //title: 'Form Fields',  
    width: 340,
    bodyPadding: 5,
...
var searchwin = Ext.create('Ext.window.Window', {
    ...
    items: [search_winForm],
    buttons: [{
        text: "保存",
        minWidth: 70,
        handler: function () {
            //debugger;
            if (search_winForm.getForm().isValid()) {
                search_winForm.getForm().submit({
                    url: '../Home.aspx',
                    //等待时显示 等待  
                    waitTitle: '请稍等...',
                    waitMsg: '正在提交信息...',
                    params: search_winForm.getValues(),

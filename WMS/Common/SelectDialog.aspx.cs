...
{
    public partial class SelectDialog : System.Web.UI.Page
    {
        int pageIndex = 1;
        int pageSize = 10;
        int totalCount = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    dtResult = bll.GetDataPage(pageIndex, pageSize, filter, ReturnField, PrimaryKey, TableView, queryFields);
        ...
        protected void btnQuery_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Request.QueryString["filterField"] != null)
                {
                    filter += " AND " + Request.QueryString["filterField"] + string.Format(" like '%{0}%'", Request.QueryString["filterValue"]);
                }

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PwdModify.aspx.cs" Inherits="WMS.WebUI.SysInfo.PwdModify.PwdModify" %>
        ...
        <table id="ModifyPwd" border="0" cellpadding="3" cellspacing="0"  align="center">
            ...
            <tr class="tableRow">
                  <td colspan="2" style=" text-align :center; height: 38px; padding-top:2em;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;
                      ...
                      <asp:Button ID="Button2" runat="server" OnClientClick="return Exit()"   CssClass="ButtonCss"  Text=" 取消"/><br />

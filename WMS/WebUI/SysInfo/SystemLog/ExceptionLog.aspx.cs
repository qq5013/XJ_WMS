...
{
    public partial class ExceptionLog : WMS.App_Code.BasePage
    {
        int pageIndex = 1;
        int pageSize = 15;
        int totalCount = 0;
        ...
        void GridDataBind()
        {
            dtLog = bll.GetDataPage("Security.SeleteExceptionalLog", pageIndex, pageSize, out totalCount, new DataParameter[] { new DataParameter("{0}", filter) });

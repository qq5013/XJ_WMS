        ...
        <tr>
          <td style=" vertical-align:top; width: 300px; padding:0pt 5pt 5pt 5pt;"><!--GroupList-->
              ...
              <table id="tblGroupUserList"  cellpadding="0" cellspacing="0" style=" width:100%;"> <!--Users in Group-->
                <tr>
                  <td style="">
                   <fieldset style="height:283px; width:298px;">
          ...
          <td style=" vertical-align:top; width: 100%;"><!--RoleSet-->
            <table cellpadding="0" cellspacing="0" width=100%>
               <tr>
                 <td style="vertical-align:top; height: 523px;">
                   <fieldset style=" width:98%; height:523px; padding:0 0 0 0;">
                     <iframe id="iframeRoleSet" src="RoleSet.aspx" height="510px" style="width:100%;" frameborder="0" scrolling="no"></iframe>
                   </fieldset>
                 </td>
               </tr>
            </table>

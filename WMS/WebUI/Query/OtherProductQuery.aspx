<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherProductQuery.aspx.cs" Inherits="WMS.WebUI.Query.OtherProductQuery" %>
        ...
        <tr runat ="server" id = "rptform" valign="top">
            <td align="left" class="style1"  >
                <table class="maintable"  width="100%" align="center"   >
                    <tr>
                        <td class="smalltitle" align="right" style="height: 24px; width: 6%;">
                            日期区间&nbsp;&nbsp;
                        </td>
                        ...
                        <td  class="smalltitle" align="right" style="height: 24px; width:6%">
                           仓库 <asp:textbox id="txtFProductID"   runat="server" Width="0px" CssClass="TextBox" heigth="0px" style="display:none" ></asp:textbox>
                        </td>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InScheduleQuery.aspx.cs" Inherits="WMS.WebUI.Query.InScheduleQuery" %>
                ...
                <table style="width: 100%; height: 20px;" class="maintable"   width="100%" align="center" 	>
                    ...
                    <tr>
                       <td class="smalltitle" align="right" style="height: 24px; width:90px">
                        ...
                        <td align="left" style="height: 24px; width:100px ">
                            &nbsp;<uc1:Calendar ID="txtCheckStartDate" runat="server" />
                        </td>
                        <td align="center" style="height: 24px;" >
                         To 
                        </td>
                        <td  style="height: 24px;width:100px  ">
                        &nbsp;<uc1:Calendar ID="txtCheckEndDate" runat="server" />
                        </td> 
                        <td>
                        </td>
                        ...
                        <td align="left" style="height: 24px; width:100px ">
                            &nbsp;<uc1:Calendar ID="txtFactStartDate" runat="server" />
                        </td>
                        <td align="center" style="height: 24px;width:20px  " >
                         To 
                        </td>
                        <td  style="height: 24px;width:100px  ">
                        &nbsp;<uc1:Calendar ID="txtFactEndDate" runat="server" />
                        </td> 
                    </tr>
                    <tr>
                         <td class="smalltitle" align="right" style="height: 24px; width:90px"> 序列号&nbsp;</td>
                       <td align="left" style="height: 24px; width:150px ">
                        ...
                        <td class="smalltitle" align="right" style="height: 24px; width:90px">订单完成状态</td>
                        <td  >

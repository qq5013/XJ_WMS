...
{
    public partial class MigrationView : WMS.App_Code.BasePage
    {
        ...
        protected void btnCheck_Click(object sender, EventArgs e)
        {
            ...
            bll.ExecNonQuery("WMS.UpdateMigrationTaskCheck", paras);
        ...
        protected void btnTask_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (this.btnTask.Text == "移库作业")
                {
                    ...
                    commands = "WMS.SPMigrationTask";
                }
                else
                {
                    paras[0] = new DataParameter("@BillID", this.txtID.Text);
                    paras[1] = null;
                    commands = "WMS.SPMigrationUnTask";
                }

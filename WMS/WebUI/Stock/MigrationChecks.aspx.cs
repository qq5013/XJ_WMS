...
{
    public partial class MigrationChecks : WMS.App_Code.BasePage
    {
        #region 参数设置
        int pageIndex = 1;
        int pageSize = 15;
        int totalCount = 0;
        int pageCount = 0;
        protected string FormID = "MigrationCheck";
        ...
        {
            DataTable dt = bll.FillDataTable("WMS.SelectMigrationDetail", new DataParameter[] { new DataParameter("{0}", string.Format("BillID='{0}' and Flag={1}", ID, Flag)) });

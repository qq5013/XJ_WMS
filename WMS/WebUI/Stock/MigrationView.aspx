<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MigrationView.aspx.cs" Inherits="WMS.WebUI.Stock.MigrationView" %>
                            ...
                            <tr>
                                ...
                                <td align="center" class="musttitle" style="width:8%" >
                                 ...
                                 <td  style=" width:18%"  >
                                     ...
                                     <asp:DropDownList ID="ddlStockType" runat="server" Height="28px" 
                                         Width="90%" Enabled="False">
                                         <asp:ListItem Value="0">正常出库</asp:ListItem>
                            ...
                            <tr>
                             ...
                             <tr>
                              ...
                              <tr>
                                 ...
                                 &nbsp;<asp:Button ID="btnCheck" runat="server" CssClass="but" Height="23px" onclick="btnCheck_Click" Text="作业审核" Width="60px" />
                                 &nbsp;&nbsp;<asp:Button ID="btnTask" runat="server" CssClass="but" Height="23px"   
                                         Text="移出作业" Width="60px" onclick="btnTask_Click" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                 </td>

...
{
    public partial class MoveEdit : WMS.App_Code.BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    txtBillDate.changed = "$('#txtID').val(autoCode('MV','Flag=1','txtBillDate'));";
                    this.txtBillDate.DateValue = DateTime.Now;
                    this.txtID.Text = bll.GetAutoCode("MV", DateTime.Now, "Flag=1");
        ...
        protected void dgViewSub1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                ((TextBox)e.Row.FindControl("ShelfCode")).Text = drv.Row.ItemArray[drv.DataView.Table.Columns.IndexOf("ShelfCode")].ToString();
                ((TextBox)e.Row.FindControl("ShelfName")).Text = drv.Row.ItemArray[drv.DataView.Table.Columns.IndexOf("ShelfName")].ToString();
        ...
        private void UpdateTempSub(GridView dgv)
        {
            ...
            for (int i = 0; i < dgv.Rows.Count; i++)
            {
                ...
                dr["ShelfCode"] = ((TextBox)dgv.Rows[i].FindControl("ShelfCode")).Text;
                dr["ShelfName"] = ((TextBox)dgv.Rows[i].FindControl("ShelfName")).Text;
        ...
        protected void btnShelf_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dt1.Rows.Count; i++)
            {
                ...
                dr["Flag"] = Flag;
                dr["BillID"] = this.txtID.Text.Trim();
                dr["ShelfCode"] = dt1.Rows[i]["ShelfCode"];
                dr["ShelfName"] = dt1.Rows[i]["ShelfName"];
        ...
        protected void btnAddDetail_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                if (dt.Rows[dt.Rows.Count - 1]["ShelfCode"].ToString() == "")
                {
                    return;
                }
            }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (ID == "") //新增
            {
                ...
                if (Count > 0)
                {
                    WMS.App_Code.JScript.Instance.ShowMessage(this.UpdatePanel1, "该管理移库单已经存在！");
                    return;
                }
            ...
            Commands[1] = "WMS.DeleteMoveSub";
            Commands[2] = "WMS.InsertMoveSub";

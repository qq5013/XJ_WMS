<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Straights.aspx.cs" Inherits="WMS.WebUI.InStock.Straights" culture="auto" uiculture="auto" MaintainScrollPositionOnPostback="true" %> 
...
<body >
    ...
    <ProgressTemplate>            
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">                
                    ...
                    <tr>
                        ...
                        <td align="left" style="height: 24px;width:90px " >
                         ...
                         <td  style="height: 24px;width:90px ">
                           &nbsp;<asp:textbox id="txtDeliverBillID" tabIndex="1" runat="server" Width="92%" CssClass="TextBox" heigth="16px" ></asp:textbox>
                        </td>
                         <td class="smalltitle" align="right" style="height: 24px;width:75px ">
                           收货人
                         </td>
                         <td align="left" style="height: 24px;width:90px ">
                           &nbsp;<asp:textbox id="txtLinkPerson" tabIndex="1" runat="server" Width="94%" 
           ...
           <div id="Maincontainer" style="overflow:auto; WIDTH: 100%; height:270px;"  runat="server" onscroll="javascript:RecordPostion(this);">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="单号"  SortExpression="ScheduleNo" >
                    <ItemTemplate>
                ...
                <asp:BoundField DataField="SourceNo" HeaderText="发货通知单" 
                    SortExpression="SourceNo"  >
                    <ItemStyle HorizontalAlign="Left" Width="15%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
                <asp:BoundField DataField="DeliverScheduleNo" HeaderText="销售单号" 
                    SortExpression="DeliverScheduleNo"  >
                    <ItemStyle HorizontalAlign="Left" Width="15%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>  
           ...
           <asp:LinkButton ID="btnFirst" runat="server" OnClick="btnFirst_Click" Text="首页"></asp:LinkButton> 
            ...
            <div id="Sub-container" style="overflow: auto; width: 100%; height: 140px" >

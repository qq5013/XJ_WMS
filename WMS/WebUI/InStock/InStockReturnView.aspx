<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InStockReturnView.aspx.cs" Inherits="WMS.WebUI.InStock.InStockReturnView" %>
				        ...
				        border="1" runat="server">			
					        <tr>
                                ...
                                <td align="center" class="smalltitle" style="width:8%;">
                                        供应商</td> 
                                <td    style="width:18%">&nbsp;<asp:TextBox ID="txtFactoryID" runat="server" BorderWidth="0" 
                                    CssClass="TextRead" Height="16px" Width="0px"></asp:TextBox>
                                    <asp:TextBox ID="txtFactoryName" runat="server" BorderWidth="0" 
                                    CssClass="TextRead" Height="16px" Width="84%" ReadOnly="True" ></asp:TextBox>
                                </td>

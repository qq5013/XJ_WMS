<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InStocks.aspx.cs" Inherits="WMS.WebUI.InStock.InStocks"  culture="auto" uiculture="auto" MaintainScrollPositionOnPostback="true" %>
    ...
    <ProgressTemplate>            
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">                
                ...
                <div>
                    ...
                    <tr>
                        ...
                        <td align="left" style="height: 24px;width:90px " >
                         ...
                         <td align="left" style="height: 24px;width:90px ">
                           &nbsp;<asp:textbox id="txtStraightID" tabIndex="1" runat="server" Width="94%" 
                        ...
                        <td align="center" style="height: 24px; width:100px">
                             <asp:Button ID="btnAdd" runat="server" Text="新增" CssClass="ButtonCreate" onclick="btnAdd_Click"  /> 
                        </td>
            ...
            <asp:GridView ID="gvMain" runat="server" AutoGenerateColumns="False" 
                    SkinID="GridViewSkin" Width="98%" OnRowDataBound="gvMain_RowDataBound">
            <Columns>
                <asp:TemplateField  >
                    <HeaderTemplate>
               ...
               <asp:TemplateField HeaderText="入库单号"  SortExpression="BillID" >
                ...
                <asp:BoundField DataField="ScheduleNo" HeaderText="采购单号" 
                    SortExpression="ScheduleNo"  >
                    <ItemStyle HorizontalAlign="Left" Width="15%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
                 <asp:BoundField DataField="FactoryName" HeaderText="供应商" 
                    SortExpression="FactoryName"  >
                    <ItemStyle HorizontalAlign="Left" Width="15%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
               <%--  <asp:BoundField DataField="FactoryOrderNo" HeaderText="工厂计划单号" 
                    SortExpression="FactoryOrderNo"  >
                    <ItemStyle HorizontalAlign="Left" Width="15%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>--%>
            ...
            <div  class="maintable" style=" height:25px">
           <asp:LinkButton ID="btnFirst" runat="server" OnClick="btnFirst_Click" Text="首页"></asp:LinkButton> 
            ...
            <div id='tabs'>
                 <div class='x-tab' title='入库明细'>   
                    ...
                    <table  class="maintable" width="100%" style=" height:25px" > 
                        <tr>
                            <td align="right">

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InStockView.aspx.cs" Inherits="WMS.WebUI.InStock.InStockView" %>
					        ...
					        <tr>
                                ...
                                <td style="width:15%">
                                    &nbsp;<asp:TextBox ID="txtSourceNo" runat="server" BorderWidth="0" CssClass="TextRead" 
                                        MaxLength="20" Width="91%" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                             <tr>
                                <td align="center" class="musttitle" style="width:10%;">
                                ...
                                <td colspan="2" style="width:23%" >
                                      &nbsp;<asp:TextBox ID="txtFactoryName" runat="server" BorderWidth="0" 
                                            CssClass="TextRead" MaxLength="20" ReadOnly="True" Width="95%"></asp:TextBox>
                                </td>
                                <td  align="center" class="smalltitle" style="width:10%;" >
                                        工厂订单号
                                </td>
                              ...
                              <td  align="center" class="musttitle" style="width:10%;" >
                                ...
                                <td style="width:15%">
                                    &nbsp;<asp:TextBox ID="txtTaskID" runat="server" BorderWidth="0" CssClass="TextRead" 
                                        MaxLength="20" Width="91%" ReadOnly="True"  ></asp:TextBox>
                                </td>
                             ...
                             <tr>
                                ...
                                <td style="width:15%">
                                      <asp:TextBox ID="txtCheckDate" runat="server" BorderWidth="0" 
                                          CssClass="TextRead" Height="16px" ReadOnly="True" Width="47%"></asp:TextBox>&nbsp;<asp:Button 
                                          ID="btnCheck" runat="server" CssClass="but" Height="23px" 

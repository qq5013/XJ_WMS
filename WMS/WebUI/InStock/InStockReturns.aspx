<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InStockReturns.aspx.cs" Inherits="WMS.WebUI.InStock.InStockReturns" culture="auto" uiculture="auto" MaintainScrollPositionOnPostback="true" %>
...
//             $("#Main-container").css("height", h - 350); //设置S界面多明细设置  
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server" UpdateMode="Conditional">                
           ...
           <div id="Maincontainer" style="overflow:auto; WIDTH: 100%; height:265px;"  runat="server" onscroll="javascript:RecordPostion(this);">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="退货单号"  SortExpression="BillID" >
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="退货日期" SortExpression="BillDate">
                    <ItemTemplate>
                ...
                <asp:BoundField DataField="CustName" HeaderText="供应商" 
             ...
             <table width="100%" class="maintable"> 
                        ...
                        &nbsp;<asp:textbox id="txtPageNoSub1" onkeypress="return regInput(this,/^\d+$/,String.fromCharCode(event.keyCode))"
                                ...
                                <asp:Literal ID="Literal3" Text="每页" runat="server" Visible="false"  />
                                    <asp:DropDownList ID="ddlPageSizeSub1" runat="server" AutoPostBack="True" Visible="false"  
                                    Height="16px" onselectedindexchanged="ddlPageSizeSub1_SelectedIndexChanged">
                 ...
                 <div class='x-tab' title='入库退货序号明细'> 
                    <div style="overflow: auto; width: 100%; height: 150px" >

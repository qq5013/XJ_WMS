<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InStockReturnEdit.aspx.cs" Inherits="WMS.WebUI.InStock.InStockReturnEdit" %>
       ...
       <script type="text/javascript" src='<%=ResolveClientUrl("~/JScript/DataProcess.js") %>'></script>
         <script type="text/javascript">
             ...
             function BindEvent() {
                 ...
                 $("#Sub1").css("height", h - 80);
                 $("#Sub2").css("height", h - 80);
			        ...
			        <table id="Table1" class="maintable" cellspacing="0" cellpadding="0" width="100%" align="center" bordercolor="#ffffff"
				        border="1" runat="server">			
					        <tr>
                                ...
                                <td >
                                &nbsp;<asp:TextBox ID="txtFactoryID" runat="server" BorderWidth="0" 

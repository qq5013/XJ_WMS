<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainTypeView.aspx.cs" Inherits="WMS.WebUI.CMD.TrainTypeView" %>
                 ...
                 <table id="Table1" class="maintable" cellspacing="0" cellpadding="0" width="100%" align="center" bordercolor="#ffffff"
				    border="1" runat="server">			
				     <tr>
                        ...
                        <td width="30%">
                                &nbsp;<asp:TextBox ID="txtTypeName" runat="server" BorderWidth="0" 

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductBoms.aspx.cs" Inherits="WMS.WebUI.CMD.ProductBoms" %>
...
<head id="Head1" runat="server">
    ...
    <script type='text/javascript'>
        function ShowViewFormBoms(obj,obj1) {

            var hrefs = location.href.split("/");
            var urlpath = "/" + hrefs[3] + "/" + hrefs[4] + "/" + hrefs[5] + "/" + FormID + "View.aspx?SubModuleCode=" + SubModuleCode + "&FormID=" + FormID + "&ProductCode=" + obj + "&ColorID=" + obj1;
    ...
    <ProgressTemplate>            
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">                
                ...
                <table style="width: 100%; height: 20px;" class="maintable">
                    <tr>
                            ...
                            <asp:dropdownlist id="ddlField" runat="server" Width="90%" >
                                    <asp:ListItem Selected="True" Value="ProductModel">产品型号</asp:ListItem>
                                    <asp:ListItem  Value="ProductNo">产品编码</asp:ListItem>
                                    <asp:ListItem Value="Name">名称</asp:ListItem>
                                    <asp:ListItem Value="Unit">单位</asp:ListItem>
                                    <asp:ListItem Value="ColorName">规格</asp:ListItem>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="产品编码"  SortExpression="ProductNo" 
                    >
                    <ItemTemplate>
                     <asp:LinkButton  id="LinkButton1" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ProductNo") %>' >
                    </asp:LinkButton>                       
                    </ItemTemplate>
                ...
                <asp:BoundField DataField="Name" HeaderText="名称" 
                 ...
                 <asp:BoundField DataField="StandPrice" HeaderText="成本价" 
                    SortExpression="StandPrice" >
                    <ItemStyle HorizontalAlign="Left" Width="15%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
                 <asp:BoundField DataField="Price1" HeaderText="子公司直营价" 
                    SortExpression="Price1" >
                    <ItemStyle HorizontalAlign="Left" Width="15%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
                 <asp:BoundField DataField="Price2" HeaderText="子公司经销商价" 
                    SortExpression="Price2" >
                    <ItemStyle HorizontalAlign="Left" Width="15%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
                 <asp:BoundField DataField="Price3" HeaderText="区域经销商" 
                    SortExpression="Price3" >
                    <ItemStyle HorizontalAlign="Left" Width="15%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
                 <asp:BoundField DataField="Price4" HeaderText="网渠价" 
                    SortExpression="Price4" >
                    <ItemStyle HorizontalAlign="Left" Width="15%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
                 <asp:BoundField DataField="Price5" HeaderText="其它价" 
                    SortExpression="Price5" >
                    <ItemStyle HorizontalAlign="Left" Width="15%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
                <asp:BoundField DataField="orderNum" HeaderText="排列顺序" 
                 ...
                 <asp:BoundField DataField="Product_Code" HeaderText="WMS产品编码" 

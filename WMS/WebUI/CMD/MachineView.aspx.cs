...
{
    public partial class MachineView :App_Code.BasePage
    {
        private string strID;
        private string TableName = "VCMD_Product";
        private string PrimaryKey = "ProductCode";
        BLL.BLLBase bll = new BLL.BLLBase();
        private string filter = "IsFixed='0' and AreaCode='002'";
        ...
        private void BindDropDownList()
        {
            ...
            DataTable ProductType = bll.FillDataTable("Cmd.SelectProductType", new DataParameter[] { new DataParameter("{0}", "cmd.AreaCode='002' and ProductTypeCode<>'0001'") });

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainTypeEdit.aspx.cs" Inherits="WMS.WebUI.CMD.TrainTypeEdit" %>
				...
				<tr>
                    ...
                    <td width="30%">
                            &nbsp;<asp:TextBox ID="txtTypeName" 
                                runat="server" BorderWidth="0" CssClass="TextBox" Width="41%" MaxLength="30" ></asp:TextBox> 
                    </td>
                </tr>

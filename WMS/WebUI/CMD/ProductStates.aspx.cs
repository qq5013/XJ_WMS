...
namespace WMS.WebUI.CMD
{
    ...
    public partial class ProductStates : App_Code.BasePage
    {
        ...
        protected void btnDeletet_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < this.GridView1.Rows.Count; i++)
            {
                ...
                if (cb != null && cb.Checked)
                {
                    ...
                    if (Count > 0)
                    {
                        WMS.App_Code.JScript.Instance.ShowMessage(this.UpdatePanel1, GridView1.Rows[i].Cells[2].Text + " 状态被其它单据使用，请调整后再删除！");
                        return;
                    }

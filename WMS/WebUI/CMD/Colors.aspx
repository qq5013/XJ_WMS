<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Colors.aspx.cs" Inherits="WMS.WebUI.CMD.Colors" %>
...
<head id="Head1" runat="server">
    ...
    <script type='text/javascript'>
        ...
        function ShowViewFormColor(obj) {
            
            var hrefs = location.href.split("/");
            var urlpath = "/" + hrefs[3] + "/" + hrefs[4] + "/" + hrefs[5] + "/" + FormID + "View.aspx?SubModuleCode=" + SubModuleCode + "&FormID=" + FormID + "&ID=" + obj;
...
<body >
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">                
                ...
                <table style="width: 100%; height: 20px;" class="maintable">
                    <tr>
                            ...
                            <asp:dropdownlist id="ddlField" runat="server" Width="90%" >
                                    ...
                                    <asp:ListItem  Value="COLOR_CODE">规格编码</asp:ListItem>
                                    <asp:ListItem Value="COLOR_NAME" >规格名称</asp:ListItem>
                          ...
                          <td align="right"  style="width:30%" valign="middle">
                            ...
                            <asp:Button ID="btnPrint" runat="server" CssClass="ButtonPrint" onclick="btnPrint_Click" Text="导出" />
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="序号"  SortExpression="ID">
                    <ItemTemplate>
                     <asp:LinkButton  id="LinkButton1" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "RowIndex") %>' >
                    </asp:LinkButton>                          
                    </ItemTemplate>
                  <ItemStyle Width="10%" Wrap="False" HorizontalAlign="Left"/>
                  <HeaderStyle Width="10%" Wrap="False" />
               </asp:TemplateField>
                <asp:BoundField DataField="ID" HeaderText="产品编码" 
               ...
               <asp:BoundField DataField="PRODUCT_Model" HeaderText="产品型号" 
                ...
                <asp:BoundField DataField="COLOR_CODE" HeaderText="颜色编码" 
                    SortExpression="COLOR_CODE" >
                    <ItemStyle HorizontalAlign="Left" Width="15%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
                <asp:BoundField DataField="COLOR_NAME" HeaderText="规格名稱" 
                ...
                <asp:BoundField DataField="MEMO" HeaderText="备注" 
                 ...
                 <asp:BoundField DataField="Product_Code" HeaderText="产品编码" 
                    SortExpression="Product_Code" Visible="false" >
                    <ItemStyle HorizontalAlign="Left" Width="10%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
     ...
     <input type="hidden" runat="server" id="hdnCurrentPage" value="1" /> 
    </form>
</body>
</html>

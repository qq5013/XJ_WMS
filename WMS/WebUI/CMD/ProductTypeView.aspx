<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductTypeView.aspx.cs" Inherits="WMS.WebUI.CMD.ProductTypeView" %>
            ...
            <ContentTemplate>
                 ...
                 <table id="Table1" class="maintable" cellspacing="0" cellpadding="0" width="100%" align="center" bordercolor="#ffffff"
				     ...
				     <tr>
                        ...
                        <td colspan="3">
                                &nbsp;<asp:TextBox 
                                    ...
                                    BorderWidth="0" CssClass="TextRead" Width="13%" MaxLength="10" 
                    ...
                    <tr>
                        ...
                        <td width="30%">
                                &nbsp;<asp:TextBox ID="txtProductTypeName" runat="server" BorderWidth="0" 

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeliverSchedules.aspx.cs" Inherits="WMS.WebUI.OutStock.DeliverSchedules" culture="auto" uiculture="auto" MaintainScrollPositionOnPostback="true" %>
    ...
    <ProgressTemplate>            
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">                
            <ContentTemplate>
              <div>
                    ...
                    <tr>
                        ...
                        <td align="left"  style="height: 24px; width:275px"  >
                    ...
                    <tr>
                        ...
                        <td align="left" style="height: 24px;width:90px " >
                           &nbsp;<asp:textbox id="txtScheduleNo" tabIndex="1" runat="server" Width="93%" 
                         ...
                         <td  style="height: 24px;width:90px ">
                           &nbsp;<asp:textbox id="txtBillID" tabIndex="1" runat="server" Width="92%" CssClass="TextBox" heigth="16px" ></asp:textbox>
                        </td>
                         <td class="smalltitle" align="right" style="height: 24px; width:80px">
                           收货人
                        </td>
                         <td align="left" style="height: 24px;width:90px ">
                           &nbsp;<asp:textbox id="txtStraightID" tabIndex="1" runat="server" Width="92%" 
                                 CssClass="TextBox" heigth="16px" ></asp:textbox>
                        </td>
                        <td class="smalltitle" align="right" style="height: 24px; width:80px">
                           状态
                        ...
                        <td colspan="2" >
                           ...
                           <asp:RadioButton ID="opt2" runat="server" GroupName="LabelSource" Text="已排单" />&nbsp;
                           <asp:RadioButton ID="opt3" runat="server" GroupName="LabelSource" Text="部分排单" />&nbsp;
                           <asp:RadioButton ID="opt4" runat="server" GroupName="LabelSource" Text="未排单" />                        
                        </td>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="销售单号"  SortExpression="ScheduleNo" >
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="接单日期" SortExpression="BillDate">
                    <ItemTemplate>
            ...
            &nbsp;<asp:Label ID="lblCurrentPage" runat="server" ></asp:Label>
                ...
                <table class="maintable" cellpadding="0" cellspacing="0" style="width: 100%; height:25px">
                    <tr>
            ...
            <div  id="Sub-container" style="overflow: auto; width: 100%; height: 150px" >
                <asp:GridView ID="dgViewSub1" runat="server" AllowPaging="True" 
                                 AutoGenerateColumns="False" onrowdatabound="dgViewSub1_RowDataBound" 
                                 PageSize="10" SkinID="GridViewSkin" Width="98%">
                                 <Columns>

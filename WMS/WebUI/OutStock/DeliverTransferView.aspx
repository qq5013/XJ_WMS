<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeliverTransferView.aspx.cs" Inherits="WMS.WebUI.OutStock.DeliverTransferView" %>
             ...
             <div id="surdiv" style="overflow: auto">
				        ...
				        border="1" runat="server">	
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td     style="width:10%;">
                                       &nbsp;<asp:TextBox ID="txtTaskChecker" runat="server" BorderWidth="0" CssClass="TextRead" 
                                        Width="91%" Height="16px"></asp:TextBox>
                                </td>
                                <td align="center" class="smalltitle" style="width:10%;">
                                        审核日期
                                ...
                                <td    style="width:10%;">
                                        &nbsp;<asp:TextBox ID="txtTaskCheckDate" runat="server" BorderWidth="0" CssClass="TextRead" 
                                        Width="92%" Height="16px"></asp:TextBox>
                                </td> 
                              ...
                              <tr>
                                ...
                                <td    style="width:10%;">
                                 ...
                                 &nbsp;<asp:Button ID="btnCheck" runat="server" CssClass="but" Height="23px"   
                                         Text="审核" Width="60px" onclick="btnCheck_Click" />
                                          &nbsp; &nbsp;
                                         <asp:Button ID="btnClose" runat="server" CssClass="but" Height="23px" 
                                          Text="出库审核" Width="60px" onclick="btnClose_Click" />
			    ...
			    <div id='tabs'>  
                    <div class='x-tab' title='明细'> 
                        <div id="sub1" style="overflow: auto; width: 100%; height: 360px" >
                    ...
                    <table style=" width:100%; height:28px"  class="maintable"  bordercolor="#ffffff" border="1"> 
                        ...
                        <tr>
                            ...
                            <asp:TextBox ID="txtTotalQty" runat="server" BorderWidth="0" 
                                    CssClass="TextRead" Height="16px" ReadOnly="True" Width="89%" style="text-align:right">
                                        </asp:TextBox>
                  ...
                  <div class='x-tab' title='序号明细'> 
                        <div id="sub2" style="overflow: auto; width: 100%; height: 360px" >

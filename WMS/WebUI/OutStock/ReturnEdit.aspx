<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReturnEdit.aspx.cs" Inherits="WMS.WebUI.OutStock.ReturnEdit" %>
...
//                 $("#surdiv").css("height", h);
             ...
             function BindEvent() {
                 ...
                 $("#btnQuery").bind("click", function () {
                     ...
                     GetOtherValue('CMD_CUSTOMER', 'txtCustomerID,txtCustomerName,txtTranCustID,txtTranCustName', "CUSTOMER_CODE,CUSTOMER_NAME,PLAYCUSTOMER_CODE,PlayCUSTOMER_NAME", "1=1");
                     return false;
                 ...
                 $("#btnInsertDetailQuery").bind("click", function () {
                     ...
                     var Where = "CustomerID='" + $('#txtCustomerID').val() + "'";
                     return GetMulSelectValue('WMS_OutStockDetailNoReturn', 'hdnMulSelect', Where);
                 });
                 ...
                 $("#btnInsertSubQuery").bind("click", function () {
                     ...
                     var Where = "CustomerID='" + $('#txtCustomerID').val() + "'";
                     return GetMulSelectValue('WMS_OutStockSubNoReturn', 'hdnMulSelect', Where);
                 });
				        ...
				        border="1" runat="server">			
					        <tr>
                                ...
                                &nbsp;<asp:TextBox ID="txtCustomerID" runat="server" BorderWidth="0" 
                                    ...
                                    CssClass="TextBox" Height="16px" Width="94%" ></asp:TextBox>
                               ...
                               <td align="center" style="width:8%;" class="musttitle">
                                ...
                                <td  colspan="3">
                                    &nbsp;<asp:TextBox ID="txtTranCustID" runat="server" BorderWidth="0" 
                                        ...
                                        CssClass="TextBox" Height="16px" Width="90%"></asp:TextBox>

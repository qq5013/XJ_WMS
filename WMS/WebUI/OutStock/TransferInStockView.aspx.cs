...
{
    public partial class TransferInStockView : WMS.App_Code.BasePage
    {
        ...
        protected void btnCheck_Click(object sender, EventArgs e)
        {
            ...
            if (StartToK3 > 0)
            {
                ...
                try
                {
                    ...
                    bll.ExecNonQueryTran("WMS.spCheckTransferInStock", paras);
                    AddOperateLog("调拨入库审核", this.txtID.Text);

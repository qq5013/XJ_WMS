<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherDeliverEdit.aspx.cs" Inherits="WMS.WebUI.OutStock.OtherDeliverEdit" %>
...
//                 $("#surdiv").css("height", h);
             ...
             function BindEvent() {
                 ...
                 $("#btnInsertDetailQuery").bind("click", function () {
                     ...
                     var Where = "Flag=" + StockType + "";
                     return GetMulSelectValue('WMS_OtherDeliverDetail', 'hdnMulSelect', Where);
                 });
                 ...
                 $("#btnInsertSubQuery").bind("click", function () {
                     ...
                     return GetMulSelectValue('WMS_OtherDeliver', 'hdnMulSelect', Where);
                 });
				        ...
				        border="1" runat="server">			
					        <tr>
                                ...
                                &nbsp;<asp:TextBox ID="txtCustomerID" runat="server" BorderWidth="0" 
                                    ...
                                    CssClass="TextBox" Height="16px" Width="84%" ></asp:TextBox>

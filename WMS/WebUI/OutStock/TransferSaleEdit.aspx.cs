...
{
    public partial class TransferSaleEdit : WMS.App_Code.BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    txtBillDate.changed = "var Prefix = makePy($('#ddlAreaSation').val().substr(0, 2));$('#txtID').val(autoCodeByTableName(Prefix[0], 'Flag=5', 'WMS_Transfer','txtBillDate'));";
                    this.txtBillDate.DateValue = DateTime.Now;
                    this.txtID.Text = bll.GetAutoCodeByTableName("BJ", "WMS_Transfer", DateTime.Now, "Flag=5");
        ...
        private void BindData(DataTable dt)
        {
            if (dt.Rows.Count > 0)
            {
                ...
                this.ddlAreaSation.SelectedValue = dt.Rows[0]["StockArea"].ToString();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (ID == "") //新增   
            {
                ...
                if (Count > 0)
                {
                    WMS.App_Code.JScript.Instance.ShowMessage(this.UpdatePanel1, "该调拨销售单号已经存在！");
                    return;
                }
            ...
            else //修改
            {
                ...
                Commands[0] = "WMS.UpdateTransferSale";
            }
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                int UnCheckQty = 0;
                DataTable dtValue = bll.FillDataTable("WMS.SelectDeliverTransferProductStockQty", new DataParameter[] { new DataParameter("@BillID", this.txtID.Text), new DataParameter("@ProductID", dt.Rows[i]["ProductID"]), new DataParameter("@ColorID", dt.Rows[i]["ColorID"]), new DataParameter("@WareHouseID", this.ddlStockFunction.SelectedValue) });
                   
                if (dt.Rows.Count >0)
                    UnCheckQty = int.Parse(dtValue.Rows[0]["StockQty"].ToString());
                if (Qty > UnCheckQty)
                {
            ...
            Commands[2] = "WMS.InsertTransferSaleSub";
        ...
        protected void btnInsertSubQuery_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
                this.ddlStockFunction.Enabled = false;
        }
        ...
        protected void btnDeleteSubQuery_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dt2.Rows.Count == 0)
                    this.ddlStockFunction.Enabled = true;
            }

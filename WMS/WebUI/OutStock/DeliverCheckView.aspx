<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeliverCheckView.aspx.cs" Inherits="WMS.WebUI.OutStock.DeliverCheckView" %>
             ...
             <div id="surdiv" style="overflow: auto">
				        ...
				        border="1" runat="server">			
					        <tr>
                               ...
                               <td align="center" class="musttitle" style="width:8%" >
                                 ...
                                 <td align="center" class="musttitle" style="width:8%" >
                                     预出库日期</td>
                                  <td  style="width:18%">
                                          &nbsp;<asp:TextBox ID="txtPlanDate" runat="server" BorderWidth="0" 
                           ...
                           <tr>  
                            ...
                            <tr>
                                ...
                                <td  style="width:15%;" >
                                     &nbsp;<asp:TextBox ID="txtTaskCheckUser" runat="server" BorderWidth="0" 
                                    ...
                                    <td  style="width:15%;">
                                         &nbsp;<asp:TextBox ID="txtTaskCheckDate" runat="server" BorderWidth="0" 
                                ...
                                <td  style="width:15%;" >
                                     &nbsp;<asp:TextBox ID="txtChecker" runat="server" BorderWidth="0" 
                                        CssClass="TextRead" Height="16px" Width="89%" ReadOnly="True"></asp:TextBox>
                             ...
                             <tr>
                                ...
                                <td  style="width:15%;" >
                                     &nbsp;<asp:TextBox ID="txtCanceler" runat="server" BorderWidth="0" 
                                        CssClass="TextRead" Height="16px" Width="89%" ReadOnly="True"></asp:TextBox>
                                    ...
                                    <td  style="width:15%;">
                                         &nbsp;<asp:TextBox ID="txtCancelDate" runat="server" BorderWidth="0" 
                                            CssClass="TextRead" Height="16px" Width="93%" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td align="center" class="smalltitle"  >
                                        直出单号
                                    ...
                                    <td  style="width:15%;">
                                         &nbsp;<asp:TextBox ID="txtStraightBillID" runat="server" BorderWidth="0" 
                                            CssClass="TextRead" Height="16px" Width="93%" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td colspan="2" align="center">
                                    ...
                                    <asp:Button ID="btnCheck" runat="server" CssClass="but" Height="23px" 
                                        onclick="btnCheck_Click" Text="出库审核" Width="80px" />&nbsp;&nbsp;&nbsp;
                                    <asp:Button ID="btnCancel" runat="server" CssClass="but" Height="23px" OnClientClick="return CancelClick();"
                                        onclick="btnCancel_Click" Text="取消出库" Width="80px" />
			    ...
			    <div id='tabs'>  
                    <div class='x-tab' title='出库明细'> 
                        <div id="sub1" style="overflow: auto; width: 100%; height: 280px" >
                            <asp:GridView ID="dgViewSub1" runat="server" AutoGenerateColumns="False" SkinID="GridViewSkin"
                                ...
                                <asp:BoundField DataField="ColorName" HeaderText="规格" >
                                 ...
                                 <asp:BoundField DataField="ScanQty" HeaderText="实际出货数量" >
                  ...
                  <div class='x-tab' title='出库序号明细'> 
                        <div id="sub2" style="overflow: auto; width: 100%; height: 280px" >

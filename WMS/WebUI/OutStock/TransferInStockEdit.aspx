<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransferInStockEdit.aspx.cs" Inherits="WMS.WebUI.OutStock.TransferInStockEdit" %>
					        ...
					        <tr>
                             ...
                             <tr>
                               ...
                               <td align="center" class="smalltitle" style="width:8%;">
                                ...
                                <td align="center" class="smalltitle" >备注    </td>
                                <td colspan="2">
                                <asp:TextBox ID="txtMemo" runat="server" CssClass="MultiLineTextBox" 
                                        TextMode="MultiLine" Height="18px" Width="99%"></asp:TextBox>
                                </td>

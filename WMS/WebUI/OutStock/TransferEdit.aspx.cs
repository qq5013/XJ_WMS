...
{
    public partial class TransferEdit : WMS.App_Code.BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    txtBillDate.changed = "$('#txtID').val(autoCode('TF','Flag=1','txtBillDate'));";
                    this.txtBillDate.DateValue = DateTime.Now;
                    this.txtID.Text = bll.GetAutoCode("TF", DateTime.Now, "Flag=1");
                ...
                SetTextReadOnly(this.txtCreateDate, txtTranCustName, this.txtStockID, this.txtCreator, txtSourceNo, txtCustomerName);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (ID == "") //新增   
            {
                ...
                para = new DataParameter[] { 
                                             ...
                                             new DataParameter("@OutStockID", this.txtStockID.Text),
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                int NotOutQty = int.Parse(bll.GetFieldValue("View_WMS_StockSubNoTran", "Qty", string.Format("BillID='{0}' and Flag=2 and ProductID='{1}' and ColorID='{2}'", this.txtStockID.Text, dt.Rows[i]["ProductID"], dt.Rows[i]["ColorID"])));

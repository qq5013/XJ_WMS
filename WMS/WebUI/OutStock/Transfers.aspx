<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Transfers.aspx.cs" Inherits="WMS.WebUI.OutStock.Transfers" culture="auto" uiculture="auto" MaintainScrollPositionOnPostback="true" %>
...
//             $("#Main-container").css("height", h - 355); //设置S界面多明细设置  
         ...
         function BindEvent() {
             ...
             $("#btnCust").bind("click", function () {
                 getMultiItems("CMD_CUSTOMER", "CUSTOMER_CODE", this, '#hdnCust');
                 return false;
             });
             $("#txtCust").bind("dblclick", function () {
                 GetOtherValueNullClear('CMD_CUSTOMER', 'txtCustID,txtCust', "CUSTOMER_CODE,CUSTOMER_NAME", "1=1");
                 return false;
             });
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server" UpdateMode="Conditional">                
            <ContentTemplate>
             <div>
                    ...
                    <tr>
                        <td class="smalltitle" align="right" style="height: 24px; width:90px">
                           变更经销商<asp:textbox id="txtCustID" tabIndex="1" runat="server" Width="0px" CssClass="TextBox" heigth="0px" style="display:none"></asp:textbox>
                        </td>
                        <td  colspan="2" >
                           &nbsp;<asp:textbox id="txtCust" tabIndex="1" runat="server" Width="87%" 
                                CssClass="TextBox" heigth="16px" ></asp:textbox>
                        </td>
                         
                         <td align="left"  style="height: 24px;width:90px ">
                           <asp:Button ID="btnCust" runat="server" CssClass="but" Text="指定"   Width="70px" Height="22px" />
                        </td>
                         <td class="smalltitle" align="right" style="height: 24px;width:75px ">
                           出库单号
                        </td>
                         <td align="left" style="height: 24px;width:90px ">
                           &nbsp;<asp:textbox id="txtStraightID" tabIndex="1" runat="server" Width="95%" 
                                 CssClass="TextBox" heigth="16px" ></asp:textbox>
                        </td>
                        ...
                        <td align="center" style="height: 24px;width:75px ">
           ...
           <div id="Maincontainer" style="overflow:auto; WIDTH: 100%; height:265px;"  runat="server" onscroll="javascript:RecordPostion(this);">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="变更单号"  SortExpression="BillID" >
                    <ItemTemplate>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <asp:TemplateField HeaderText="变更日期" SortExpression="BillDate">
                    <ItemTemplate>
                ...
                <asp:BoundField DataField="OutStockID" HeaderText="出库单号" 
                    SortExpression="OutStockID"  >
                ...
                <asp:BoundField DataField="CustName" HeaderText="经销商" 
                 ...
                 <asp:BoundField DataField="TranCustomerName" HeaderText="变更经销商" 
                ...
                <input type="hidden" id="dvscrollY" runat="server" />  
                 ...
                 <input type="hidden" id="HdnProduct" runat="server" />
                  <input type="hidden" id="hdnColor" runat="server" />
                   <input type="hidden" id="HdnCust" runat="server" />
            </div>
            </ContentTemplate>
        </asp:UpdatePanel> 
    </form>

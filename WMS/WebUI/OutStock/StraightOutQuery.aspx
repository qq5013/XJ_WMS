<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StraightOutQuery.aspx.cs" Inherits="WMS.WebUI.OutStock.StraightOutQuery" culture="auto" uiculture="auto" MaintainScrollPositionOnPostback="true" %>
...
<body >
    ...
    <ProgressTemplate>            
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">                
                ...
                <table style="width: 100%; height: 20px;" class="maintable">
                    <tr>
                            ...
                            <asp:dropdownlist id="ddlField" runat="server" Width="90%" >
                                   <asp:ListItem Value="BillID">发货通知单</asp:ListItem>
                                    <asp:ListItem Value="BillDate">发货日期</asp:ListItem>
            ...
            <div id="Maincontainer" style="overflow:auto; WIDTH: 100%; height:220px;"  runat="server" onscroll="javascript:RecordPostion(this);">
            ...
            <Columns>
                 ...
                 <asp:BoundField DataField="BillID" HeaderText="发货通知单" 
                    SortExpression="BillID"  >
                    <ItemStyle HorizontalAlign="Left" Width="15%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>

                <asp:TemplateField HeaderText="发货日期" SortExpression="BillDate">
                    <ItemTemplate>

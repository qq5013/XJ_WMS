<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransferSaleEdit.aspx.cs" Inherits="WMS.WebUI.OutStock.TransferSaleEdit" %>
...
//                 $("#surdiv").css("height", h);
             ...
             function BindEvent() {
                 ...
                 $("#btnCustQuery").bind("click", function () {
                     ...
                     GetOtherValue('CMD_CUSTOMER', 'txtTranCustID,txtTranCustName', "CUSTOMER_CODE,CUSTOMER_NAME", "1=1");
                     return false;
                 });

                 $("#btnQuery").bind("click", function () {

                     GetOtherValue('CMD_CUSTOMER', 'txtCustomerID,txtCustomerName,txtTranCustID,txtTranCustName,hdnCustomerType', "CUSTOMER_CODE,CUSTOMER_NAME,PLAYCUSTOMER_CODE,PlayCUSTOMER_NAME,CustomerType", escape("areasation='" + $('#ddlAreaSation').val() + "'"));
                     return false;
                 ...
                 $("#btnInsertDetailQuery").bind("click", function () {
                     ...
                     var StockType = $('#ddlStockFunction').val();


                     var Where = "WareHouseID=" + StockType + "";
                     return GetMulSelectValue('WMS_DeliverTransferDetail', 'hdnMulSelect', Where);
                 });
                 ...
                 $("#btnInsertSubQuery").bind("click", function () {
                     ...
                     return GetMulSelectValue('WMS_DeliverTransfer', 'hdnMulSelect', Where);
                 });

                 $("[ID$='Price']").bind("change", function () {
                     ChangePrice(this);
                 });
                 $("[ID$='Qty']").bind("change", function () {
                     ChangePrice(this);
                 });
             ...
             function ChangeAutoCode() {
                 ...
                 $('#txtID').val(autoCodeByTableName(Prefix[0], 'Flag=5', 'WMS_Transfer', 'txtBillDate'));
             ...
             function Save() {
                 ...
                 if (!ChkDelMustNumericValue("dgViewSub1", "Qty", "数量"))
                     return false;
					        ...
					        <tr>
                             ...
                             <tr>
                                ...
                                &nbsp;<asp:TextBox ID="txtCustomerID" runat="server" BorderWidth="0" 
                                    ...
                                    CssClass="TextBox" Height="16px" Width="78%" ></asp:TextBox>
                                     <asp:Button ID="btnQuery" runat="server" CssClass="ButtonCss" Text="..." 
                                        Width="20px" />
                                </td>
                               <td align="center" style="width:8%;" class="musttitle">
                                        子公司
                                ...
                                <td   >
                                    &nbsp;<asp:TextBox ID="txtTranCustID" runat="server" BorderWidth="0" 
                                        ...
                                        CssClass="TextBox" Height="16px" Width="81%"></asp:TextBox>
                                    ...
                                    onrowdatabound="dgViewSub1_RowDataBound">
                                         <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="数量">
                                                <ItemTemplate>
                                                   <asp:TextBox ID="Qty" runat="server" Width="95%" CssClass="detailtext" style="text-align:right;" 

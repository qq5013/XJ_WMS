<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherDelivers.aspx.cs" Inherits="WMS.WebUI.OutStock.OtherDelivers" culture="auto" uiculture="auto" MaintainScrollPositionOnPostback="true" %>
                ...
                <table style="width: 100%; height: 20px;" class="maintable">
                    <tr>
                            ...
                            <asp:dropdownlist id="ddlField" runat="server" Width="90%" >
                                    ...
                                    <asp:ListItem Value="TranCustomerName">子公司</asp:ListItem> 

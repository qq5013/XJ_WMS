...
{
    public partial class TransferInStockEdit : WMS.App_Code.BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    txtBillDate.changed = "$('#txtID').val(autoCode('DI', 'Flag=6','txtBillDate'));";
                    this.txtBillDate.DateValue = DateTime.Now;
                    this.txtID.Text = bll.GetAutoCode("DI", DateTime.Now, "Flag=6");
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (ID == "") //新增   
            {
                ...
                if (Count > 0)
                {
                    WMS.App_Code.JScript.Instance.ShowMessage(this.UpdatePanel1, "该调拨入库单号已经存在！");
                    return;
                }
                ...
                para = new DataParameter[] { 
                                             ...
                                             new DataParameter("@CustomerID", ""),
                                             new DataParameter("@TranCustomerID", ""),
                                             new DataParameter("@Memo", this.txtMemo.Text.Trim()),
                                             new DataParameter("@StockArea", ""),

...
{
    public partial class TransferSaleView : WMS.App_Code.BasePage
    {
        ...
        protected void btnCheck_Click(object sender, EventArgs e)
        {
            ...
            if (StartToK3 > 0)
            {
                ...
                try
                {
                    ...
                    {
                        paras[0] = new DataParameter("@UserName", "");
                        paras[1] = new DataParameter("{0}", null);
                    }
                    paras[2] = new DataParameter("@BillID", this.txtID.Text);
                    AddOperateLog("调拨销售", btnCheck.Text);

                    bll.ExecNonQuery("WMS.UpdateTransferSaleCheck", paras);
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            AddOperateLog("调拨销售单", "删除单号：" + strID);

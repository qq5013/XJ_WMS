<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransferView.aspx.cs" Inherits="WMS.WebUI.OutStock.TransferView" %>
             ...
             <div id="surdiv" style="overflow: auto">
				        ...
				        border="1" runat="server">			
					        <tr>
                                ...
                                <td align="center" class="musttitle" style="width:8%" >
                                    出库单号</td>
                                  <td  style="width:18%">
                                        &nbsp;<asp:TextBox ID="txtStockID" runat="server" BorderWidth="0" CssClass="TextRead" 
                                        Width="81%" Height="16px" ReadOnly="True"></asp:TextBox>
                                </td>
                                 <td align="center" class="musttitle" style="width:8%" >
                                     销售单号
                                </td>
			    ...
			    <div id='tabs'>  
                  ...
                  <div class='x-tab' title='变更序号明细'> 
                        ...
                        <table width="100%" class="maintable"  bordercolor="#ffffff" border="1" style=" height:28px" > 
                        <tr>
                            <td align="right">

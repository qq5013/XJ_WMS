<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectDialog.aspx.cs" Inherits="WMS.Common.SelectDialog" %>
...
<body style="margin:0 0 0 0; background-color:#f8f8f8; overflow:hidden;" onload="return window_onload()" onunload="return window_onunload()">
    ...
    <div style=" padding-left:5px; padding-right:5px; height:220px;overflow:auto;"><!--data-->

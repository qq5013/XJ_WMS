<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Spliter.aspx.cs" Inherits="WMS.Index.Spliter" %>
...
<body style="left: 0px; top: 0px; margin: 0 0 0 0;">
    <table height="100%" width="8px" border="0" cellpadding="0" cellspacing="0" style="background-image: url(../images/leftmenu/shu_bg.jpg);">
        <!--DWLayoutTable-->
        <tr>
            <td height="35%" valign="top" style="width: 8px">
                <img src="../images/leftmenu/shu_top.jpg" />
            </td>
        </tr>
        <tr>
            <td nowrap style="width: 8px">
                <a href="#">
                    <img id="IMG1" alt="隐藏导航栏" onclick="return adjust2()" src="../images/leftmenu/right.jpg"
                        border="0" name="IMG1" /></a>
            </td>
        </tr>
        <tr>
            <td height="45%" valign="top" style="width: 8px">
                <!--DWLayoutEmptyCell-->
                &nbsp;
            </td>
        </tr>
